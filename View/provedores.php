                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active">Registro Provedor
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Registro Provedores</h4>
                            </div>
                                ...
                                <div class="card-body">
                                    <form action="#" class="wizard-horizontal">
                                        ...
                                        <fieldset>
                                            <div class="row">
                                                <div class="col-12">
                                                    <h6 class="py-50">Ingrese los detalles personales</h6>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="firstName13">Primer Nombre </label>
                                                        <input type="text" class="form-control" placeholder="Ingrese el primero nombre">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="lastName12">Segundo Nombre</label>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="emailAddress1">Apellido Paterno</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="Engrese su docimento de identidad">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                        ...
                                        <fieldset>
                                            <div class="row">
                                                <div class="col-12">
                                                    <h6 class="py-50">Datos Provedore</h6>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label>Direccion Central</label>
                                                        <input type="text" class="form-control" placeholder="Ingrese la direccion de la central.">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label>Telefono central</label>
                                                        <input type="number" class="form-control" placeholder="Ingrese el telefono de la central">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label>Telefono Contacto</label>
                                                        <input type="number" class="form-control" placeholder="Ingrese el telefono del contacto">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label>Email</label>
                                                        <input type="email" class="form-control" placeholder="Ingrese el Email de la empresa">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-sm-4 d-flex align-items-center">
                                                    <div class="form-group">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="checkbox1">Provedor activo</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <fieldset>
                                            <div class="row">
                                                <div class="col-12">
                                                    <h6 class="py-50" align="center">Terminos y Condiciones</h6><br>
                                                </div>
                                                <div class="col-12">
                                                    <p>
                                                    ...
                                                    <strong>Lea todos los términos y condiciones cuidadosamente.</strong>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <div class="radio">
                                                            <input type="radio" name="bsradio" id="agree">
                                                            <label for="agree" class="text-success">Leo todos los términos y condiciones y estoy de acuerdo.</label>
                                                        </div>
                                                        <div class="radio">
                                                            <input type="radio" name="bsradio" id="disagree">
                                                            <label for="disagree" class="text-danger">No estoy de acuerdo con eso.</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
