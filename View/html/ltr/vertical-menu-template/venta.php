            ...
            <div class="content-body">
                ...
                <section class="invoice-edit-wrapper">
                    <div class="row">
                        ...
                        <div class="col-xl-1 col-md-8 col-12" ></div>
                                ...
                                <div class="card-content">
                                    <div class="card-body pb-0 mx-25">
                                        ...
                                        <div class="row my-2 py-50">
                                            <div class="col-sm-6 col-12 order-2 order-sm-1">
                                                <h4 class="text-primary">Código de control - 013524430</h4>
                                            </div>
                                                ...
                                                <fieldset class="invoice-address form-group">
                                                    <div class="invoice-item-filed row pt-1 px-1">
                                                        <div class="col-12 col-md-4 form-group">
                                                            <h6 class="invoice-to">Cliente</h6>
                                                            <select class="form-control invoice-item-select">
                                                                <option value="Frest Admin Template">Ronald Vega</option>
                                                                <option value="Stack Admin Template">Rodrio Pereira</option>
                                                                <option value="Robust Admin Template">Carlos Ojeda</option>
                                                                <option value="Apex Admin Template">Ariel Vargas</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-12 col-md-3 form-group">
                                                            <h6 class="invoice-to">Cliente</h6>
                                                            <select class="form-control invoice-item-select">
                                                                <option value="Frest Admin Template">001 - Consumo de Internet</option>
                                                                <option value="Stack Admin Template">002 - Consumo de Megas</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-md-5 col-12 form-group"><br>
                                                            <strong class="text align-middle">Nro. Solicitud : </strong>
                                                            <strong class="text-primary align-middle"> 0013</strong>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                                <fieldset class="invoice-address form-group">
                                                    <textarea class="form-control" rows="4" placeholder="Global Consumo"></textarea>
                                                </fieldset>
                                            </div>
                                        </div>
                                        <hr>
                                    ...
                                    <div class="card-body pt-50">
                                            ...
                                            <form class="form invoice-item-repeater">
                                                <div data-repeater-list="group-a">
                                                    <div data-repeater-item>
                                                        <div class="row mb-50">
                                                            <div class="col-3 col-md-4 invoice-item-title">Nombre Articulo</div>
                                                            <div class="col-3 invoice-item-title">Codigo Articulo</div>
                                                        ...
                                                        <div class="invoice-item d-flex border rounded mb-1">
                                                            <div class="invoice-item-filed row pt-1 px-1">
                                                                ...
                                                                <div class="col-md-12 col-12 form-group">
                                                                    <input type="text" class="form-control invoice-item-desc" value="" placeholder="Indicamos si el producto esta saliendo bien o mal o alguna caracteristica de la venta">
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col p-0">
                                                        <button class="btn btn-light-primary btn-sm" data-repeater-create type="button">
                                                            ...
                                                            <span class="invoice-repeat-btn">Añadir Articulo</span>
                                                        </button>
                                                    </div>
                                                </div>
                                            </form>
                                        ...
                                        <div class="invoice-subtotal pt-50">
                                            <div class="row">
                                                <div class="col-md-1 col-12"><br><br><br>
                                                    <img src="../../../app-assets/images/pages/qr5.png" alt="logo" height="150" width="164">
                                                </div>
                                                <div class="col-md-1 col-12">
                                                </div>
                                                <div class="col-md-3 col-12"><br><br><br><br>   <br>
                                                    <h5 align="center">+ (591) 6550***9</h5>
                                                    <p align="center" class="text-muted font-medium-1">Siempre estamos felices de ayudar!</p>
                                                </div>
                                                <div class="col-lg-5 col-md-7 offset-lg-2 col-12">
                                                    <ul class="list-group list-group-flush">
                                                        ...
                                                        <li class="list-group-item border-0 pb-0">
                                                            <button class="btn btn-primary btn-block subtotal-preview-btn"><a href="factura.html" style="color: #ffffff;">Aceptar</a></button>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
